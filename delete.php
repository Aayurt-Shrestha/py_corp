...
<html lang="en">
<head>
  <title>DELETE of database</title>
  <meta charset="utf-8">
...
<?php 
    ...
    ?>
<div class="container">
  <h1 align="center">DELETION OF DATABASE</h1> 
  <hr>
  <table class="table table-hover">
    ...
    <?php
        ...
        while ($b = mysqli_fetch_assoc($query)) {
              echo "<tr><td><a style='color:red;' href='delete1.php?id=".$b['id']."'>".$b['id']."</a></td><td>".$b['name']."</td><td>".$b['email']."</td><td>".$b['password']."</td></tr>";
        }
    ?>
  </table>        
